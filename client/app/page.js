...
import FeatureBentoGrid from "./_component/FeatureBentGrid";
    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"🩺Revolutionize Healthcare with AI-Voice Agents"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.p
          ...
          Faster, accurate, and natural voice interactions for patient care, appointment management, and medical assistance — anytime, anywhere.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
